...
\cs_new:Nn \xsim_nested_setup:nn {
    \xsim_setup:n{
        #1/pre-hook={
...
\cs_generate_variant:Nn \xsim_nested_setup:nn {xn,nx,xx}
\NewDocumentCommand \XSIMNestedSetup {mo} {
    \IfNoValueTF{#2} {
        \xsim_nested_setup:nx{#1}{\ExerciseParameterGet{#1}{solution-env}}
    }{
        \xsim_nested_setup:nn{#1}{#2}
    }
}
