...
\cs_new:Nn \xsim_nested_points_pre_hook:n {
    \xsim_unset_property:nxn{#1}{\l_xsim_nested_container_tl}{points-nested-tmp}
}
...
\cs_new:Nn \xsim_nested_points_post_hook:n {
    ...
    \xsim_if_property_set:eenTF{#1}{\l_xsim_nested_container_tl}{points}{
        % if we have points-nested-tmp assigned from nested tasks
        \xsim_if_property_set:eenTF{#1}{\l_xsim_nested_container_tl}{points-nested-tmp}{
            % sum both to points-sum
            \xsim_set_property:eene{#1}{\l_xsim_nested_container_tl}{points-nested}{
                \xsim_get_property:non{#1}{\l_xsim_nested_container_tl}{points-nested-tmp}
            }
            \xsim_set_property:eene{#1}{\l_xsim_nested_container_tl}{points-sum}{%
                \xsim_get_property:non{#1}{\l_xsim_nested_container_tl}{points} %
                + %
                (\xsim_get_property:non{#1}{\l_xsim_nested_container_tl}{points-nested})%
            }
        }{
            % else only add our points to the points-nested
            \xsim_unset_property:nxn{#1}{\l_xsim_nested_container_tl}{points-nested}
            \xsim_set_property:eene{#1}{\l_xsim_nested_container_tl}{points-sum}{%
                \xsim_get_property:non{#1}{\l_xsim_nested_container_tl}{points}
            }
        }
        ...
        \xsim_if_property_set:eenTF{#1}{\l_xsim_nested_container_tl}{points-nested-tmp}{
            ...
            \xsim_unset_property:nxn{#1}{\l_xsim_nested_container_tl}{points-nested}
            \xsim_unset_property:nxn{#1}{\l_xsim_nested_container_tl}{points-sum}
        }
    }

    % if we have any form of points
    \xsim_if_property_set:eenT{#1}{\l_xsim_nested_container_tl}{points-sum}{
        ...
        \xsim_if_property_set:eenT{#1}{\l_xsim_nested_container_tl}{container}{
            ...
            \xsim_verbose:x {
                ...
                \xsim_get_property:oon{\l_xsim_nested_points_contt_tl}{\l_xsim_nested_points_cont_tl}{points-nested-tmp}
                 ~ + ~ 
                \xsim_get_property:non{#1}{\l_xsim_nested_container_tl}{points-sum}%
            }

            % if the container already has points-nested-tmp
            \xsim_if_property_set:eenTF{\l_xsim_nested_points_contt_tl}{\l_xsim_nested_points_cont_tl}{points-nested-tmp}{
                % add our points-sum to the container's points-nested-tmp
                \xsim_set_property:eene{\l_xsim_nested_points_contt_tl}{\l_xsim_nested_points_cont_tl}{points-nested-tmp}{%
                    \xsim_get_property:oon{\l_xsim_nested_points_contt_tl}{\l_xsim_nested_points_cont_tl}{points-nested-tmp} %
                    + %
                    \xsim_get_property:non{#1}{\l_xsim_nested_container_tl}{points-sum}%
                }
...
\NewDocumentCommand \XSIMNestedPointsSetup {m} {\xsim_nested_points_setup:n{#1}}
