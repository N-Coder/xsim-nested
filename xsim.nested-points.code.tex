...
\cs_new:Nn \xsim_nested_points_post_hook:n {
    ...
    \xsim_if_property_set:xxnT{#1}{\g_xsim_nested_container_tl}{points-sum}{
        ...
        \xsim_if_property_set:xxnT{#1}{\g_xsim_nested_container_tl}{container}{
            ...
            \tl_set:Nx \l_xsim_nested_points_cont_tl  {\xsim_get_property:nVn{#1}{\g_xsim_nested_container_tl}{container}}
            \tl_set:Nx \l_xsim_nested_points_contt_tl {\xsim_get_property:nVn{#1}{\g_xsim_nested_container_tl}{container-type}}
